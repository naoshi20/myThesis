...
# amusement --------------------------------------------------------------------
# 標準化前
#result <- lm(amusement~AU1+AU2+AU4+AU5+AU6+AU7+AU10+AU12+AU14+AU15+AU17+AU21+AU23+AU25+AU26, data)
#summary(result)

#標準化後
result <- lm(amusement~AU1+AU2+AU4+AU5+AU6+AU7+AU10+AU12+AU14+AU15+AU17+AU21+AU23+AU25+AU26, z)
summary(result)
...
filename <- "./result/regression/amusement.csv"
