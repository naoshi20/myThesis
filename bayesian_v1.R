...
write.csv(s_fit, file = "./result/bayesian/amusement_summary.csv", row.names = FALSE)
...
s_fit %>% 
  ...
  write.csv("result/bayesian/amusement_estimates.csv", row.names = FALSE)
...
ggsave("result/bayesian/est_amusement.png", g, width = 2.5, height = 2.5, dpi = 600)
